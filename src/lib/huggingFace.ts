...
function buildColumnMappingPrompt(inferences: ColumnInference[]) {
  ...
  return [
    ...
    "- Headers named Date, Dates, Timestamp, Огноо, Өдөр, or Хугацаа must be role date. Never classify those headers as score or grade, even when their cell values contain numbers.",
