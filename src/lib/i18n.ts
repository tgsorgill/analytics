...
const mn: Partial<Record<TranslationKey, string>> = {
  ...
  "dashboard.normalizedRecords": "нэгтгэсэн бичлэг",
  ...
  "individual.safety": "Зөвхөн детерминистик бичлэг. AI хувь хүний шинжилгээ, зэрэглэл, онош, таамаглал хийхгүй.",
  ...
  "individual.noTrend": "Ахиц харуулах давтагдсан бичлэг хангалтгүй байна.",
  "individual.strongest": "Хүчтэй хамралт",
  "individual.watch": "Анхаарах хэсэг",
  "individual.coverage": "Хамралтын гүн",
  "individual.recentRecords": "Сүүлийн бичлэгүүд",
  ...
  "trend.empty": "Ангиллын сайжрал эсвэл бууралтын чиг хандлага одоогоор алга. Огноотой бичлэг, давтагдсан шалгалт эсвэл дараалалтай өгөгдөл нэмнэ үү.",
  "exports.kicker": "Экспорт",
  "exports.title": "Дотоод тайлан болон өгөгдлөө татах",
  "exports.body": "Экспорт нь backend хадгалалтыг орлоно: сервер дээр ангийн өгөгдөл хадгалахгүйгээр нэгтгэсэн бичлэг, детерминистик аналитик, AI хураангуй, PDF тайлан татна.",
  ...
  "exports.normalizedRecords": "Нэгтгэсэн бичлэг",
...
const labelMn: Record<string, string> = {
  ...
  "Earlier records": "Өмнөх бичлэгүүд",
  "Later records": "Сүүлийн бичлэгүүд",
